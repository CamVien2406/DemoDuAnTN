                ...
                <View style={styles.content}>
                    {status === 6 ?
                        <View style={styles.item}>
                            <Image source={require('../../asset/image/cross.png')} />
                            <Text style={styles.textItem}>Đã đặt hàng thất bại</Text>
                        </View>
                        :
                        <View style={styles.item}>
                            <Image source={require('../../asset/image/shopping-bag.png')} />
                            <Text style={styles.textItem}>Đã xác nhận đơn hàng</Text>
                        </View>
                    }
                    <View style={styles.item}>
                        <Image source={require('../../asset/image/delivered.png')} />
                        <Text style={styles.textItem}>Đang đóng gói</Text>
                    </View>
                    <View style={styles.item}>
                        <Image source={require('../../asset/image/shipped.png')} />
